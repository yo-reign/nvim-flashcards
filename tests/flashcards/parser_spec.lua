describe("parser", function()
  ...
  describe("inline cards", function()
    ...
    it("preserves ordinary parenthesized prefixes in inline fronts", function()
    ...
    it("extracts explicit free-form source refs from inline fronts", function()
      local cards, errors = parser.parse("test.md", "(ref: exercise 4a) What is X? ::: Y", "")
      assert.equals(0, #errors)
      assert.equals(1, #cards)
      assert.equals("What is X?", cards[1].front)
      assert.equals("exercise 4a", cards[1].note)
    end)

    it("extracts exact section references like 1.1.1:2", function()
      local cards, errors = parser.parse("test.md", "(1.1.1:2) What is a set? ::: A collection", "")
      assert.equals(0, #errors)
      assert.equals(1, #cards)
      assert.equals("What is a set?", cards[1].front)
      assert.equals("1.1.1:2", cards[1].note)
    end)
