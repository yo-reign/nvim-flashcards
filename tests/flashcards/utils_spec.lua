describe("utils", function()
  ...
  describe("extract_source_ref", function()
    ...
    it("extracts arbitrary parenthesized prefixes", function()
      local ref, text = utils.extract_source_ref("(optional) What is X?")
      assert.equals("optional", ref)
      assert.equals("What is X?", text)
    end)

    it("extracts source refs with punctuation and spaces", function()
      local ref, text = utils.extract_source_ref("(Lang, Algebra I §2) Define a group")
